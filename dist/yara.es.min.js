var hljsGrammar=(()=>{"use strict";return e=>({name:"YARA",contains:[{
  className:"attr",begin:/"(\\.|[^\\"\r\n])*"(?=\s*:)/,relevance:1.01},{
  className:"variable",match:"(\\$|#|@)[a-zA-Z0-9_*]*",relevance:1.01},{
  match:"/[()]/|/[{}]/|/[[/|/[[]]/|/\\/|/,/",className:"punctuation",relevance:0
  },{match:/\b[0-9A-Fa-f]{2}\b/g,className:"number",relevance:0
  },e.QUOTE_STRING_MODE,{
